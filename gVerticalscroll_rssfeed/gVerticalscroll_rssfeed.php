...
//############################################################################################################
//###### Project   : Vertically scroll rss feed 														######
//###### File Name : gVerticalscroll_rssfeed.php                   										######
//###### Purpose   : Vertically scroll the rss feed at front end										######
//###### Date      : June 30th 2009                  													######
//###### Author    : Gopi.R                        														######
//############################################################################################################
...
function gVerticalscroll_rss()
{
	...
	if($rss)
	{
		...
		foreach($items as $item)
		{
			...
			$myLink =  '<a target="_blank" href="'.$link.'">'.addslashes($title).'</a>';
	...
	<script language="JavaScript" src="<?php echo get_option('siteurl'); ?>/wp-content/plugins/gVerticalscroll_rssfeed/gVerticalscroll_rssfeed.js"></script>
	</div>
	<?php
}
